...
const Services = () => {
  return (
    <div className='text-white pb-[100px] pt-[50px] lg:pt-[100px]  bg-bv-black-1 font-lato px-[22px] lg:px-[104px]'>
      ...
      <section className='bg-white text-bv-black-1 mt-10 grid grid-cols-1 lg:grid-cols-3 p-6 lg:p-10 rounded-2xl gap-5'>
        ...
        <div className='flex flex-col w-full font-lato text-white space-y-5 lg:col-span-2'>
      ...
      <section className='mt-10 text-bv-black-1 grid  grid-cols-1 lg:grid-cols-3 gap-10'>
        <div className='rounded-2xl flex flex-col space-y-4 bg-white p-5 '>
        ...
        <div className='rounded-2xl flex flex-col space-y-4 bg-bv-blue-1 p-5 '>
      ...
      {/* <section className='mt-[120px]'>
        <h1 className='font-clash mt-4 text-[48px] '>Featured Projects</h1>
        <div className='grid grid-cols-2 mt-10 gap-[56px]'>
          <div className='flex flex-col space-y-[32px]'>
            <p className='text-[36px] font-semibold'>TAAS</p>
            <Image src={taas} alt='Image' />
            <div className='flex justify-between max-w-[367px]'>
          ...
          <div className='flex flex-col space-y-[32px]'>
            <p className='text-[36px] font-semibold'>Artizen</p>
            <Image src={artizen} alt='Image' />
            <div className='flex justify-between max-w-[220px]'>
              <div className='border rounded-full px-5 py-3 '>Blockchain</div>
              <div className='border rounded-full px-8 py-3 '>Art</div>
            </div>
          </div>
          <div className='flex flex-col space-y-[32px]'>
            <p className='text-[36px] font-semibold'>GlobaChain</p>
          ...
          <div className='flex flex-col space-y-[32px]'>
            <p className='text-[36px] font-semibold'>Tixhive</p>
            <Image src={artizen} alt='Image' />
            <div className='flex justify-between max-w-[337px]'>
